  ...
  switch (rarity) {
    ...
    // IMPORTANT: Common ring off, otherwise it looks like “thicker border”
    switch (rarity) {
        case "Uncommon":
  ...
  return "bg-emerald-800/20 text-emerald-200 border-emerald-400/35";
     ...
     * This guarantees hover tint shows up even with bg-black/20 present.
     */
    ...
    switch (rarity) {
        ...
        return [
            ...
            "before:from-emerald-500/20 before:via-emerald-500/10 before:to-transparent",
        ].join(" ");
        case "Rare":
        return [
            "before:absolute before:inset-0 before:opacity-0 hover:before:opacity-100",
            "before:transition-opacity before:duration-200",
            "before:bg-gradient-to-t",
            "before:from-sky-500/20 before:via-sky-500/10 before:to-transparent",
        ].join(" ");
        case "Epic":
        return [
            "before:absolute before:inset-0 before:opacity-0 hover:before:opacity-100",
            "before:transition-opacity before:duration-200",
            "before:bg-gradient-to-t",
            "before:from-violet-500/20 before:via-violet-500/10 before:to-transparent",
        ].join(" ");
        case "Legendary":
    return [
        "before:absolute before:inset-0 before:opacity-0 hover:before:opacity-100",
        "before:transition-opacity before:duration-200",
        "before:bg-gradient-to-t",
        "before:from-amber-400/30 before:via-amber-500/14 before:to-transparent",
    ].join(" ");
