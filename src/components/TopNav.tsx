  ...
  return (
    <div className="relative z-50 w-full h-14 border-b border-white/10 bg-neutral-900">
      ...
      <div className="max-w-6xl mx-auto h-full px-6 flex items-center justify-between">
        ...
        {/* Right side */}
        <div className="flex items-center gap-4 text-sm text-neutral-300 min-w-0">
          <div className="flex items-center gap-1 min-w-0">
            <span className="text-neutral-400 truncate">WalletADHD</span>
            <span className="text-blue-400 font-medium shrink-0">100</span>
          </div>

          <img
            src="https://avatars.fastly.steamstatic.com/dafbf49a3013de1a9528e06e796f49b8a8bdfef2_full.jpg"
            alt="Profile avatar"
